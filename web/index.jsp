<%-- 
    Document   : index
    Created on : Dec 14, 2016, 4:56:29 AM
    Author     : Bona
--%>


<%@page import="java.util.ArrayList"%>
<%@page import="Barang_Control.Barang"%>
<%@page import="Barang_Control.Query_Barang"%>
			...
			<div class="shoe">
				...
				<div class="content-bottom">
					...
					<div class="bottom-grid">
                                            ...
                                            ArrayList<Barang> brg=barang.listbarang();
                                            ...
                                            if(pg==null || pg.equals("1")){
                                                ...
                                                maxInt=9*Integer.parseInt(pg);
                                                if(brg.size() < maxInt){
                                                    maxInt=brg.size();
                                                }
                                                minInt=(9*(Integer.parseInt(pg)-1));
                                            }
                                            
                                            for (int i = minInt; i < maxInt; i++){
                                            %>
                                            <div class="col-md-4 shirt" style="padding-bottom: 15px; padding-top: 15px">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="images/sh.png" alt="" >
								<div class="pre">
                                                                    <p><% out.println(brg.get(i).getNama()); %></p>
									<span><% out.println(brg.get(i).getHarga()); %></span>
									<div class="clearfix"> </div>
								</div></a>
							</div>
						</div>
				...
				<ul class="start">
                                    <%
                                        ...
                                        %>
                                        <li class="arrow"><a href="<% out.println("?page="+(i+1));%>"><%out.println(i+1);%></a></li>
                                       <% }
                                    %>
